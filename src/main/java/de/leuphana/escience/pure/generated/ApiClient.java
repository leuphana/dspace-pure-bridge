...
import de.leuphana.escience.pure.generated.auth.Authentication;
import de.leuphana.escience.pure.generated.auth.HttpBasicAuth;
import de.leuphana.escience.pure.generated.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://pure-dev.leuphana.de/ws/api";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://pure-dev.leuphana.de/ws/api",
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/5.31.1-1/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://pure-dev.leuphana.de/ws/api
