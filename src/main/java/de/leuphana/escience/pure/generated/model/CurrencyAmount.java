...
/**
 * A monetary value in the specified currency as defined by the W3C&#39;s Payment Request standard: https://www.w3.org/TR/payment-request/#paymentcurrencyamount-dictionary
 */
...
public class CurrencyAmount {
  ...
  public CurrencyAmount currency(@javax.annotation.Nonnull String currency) {
    this.currency = currency;
    return this;
  }

  /**
   * An ISO-4217 3-letter alphabetic code as defined by the W3C&#39;s Payment Request standard: https://www.w3.org/TR/payment-request/#dom-paymentcurrencyamount-currency
   * @return currency
   */
  @javax.annotation.Nonnull
  ...
  public CurrencyAmount value(@javax.annotation.Nonnull String value) {
    this.value = value;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!CurrencyAmount.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CurrencyAmount` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
