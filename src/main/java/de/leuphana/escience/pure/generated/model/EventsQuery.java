...
public class EventsQuery {
  ...
  public EventsQuery uuids(@javax.annotation.Nullable List<UUID> uuids) {
    this.uuids = uuids;
    return this;
  }
  ...
  public EventsQuery size(@javax.annotation.Nullable Integer size) {
    this.size = size;
    return this;
  }
  ...
  public EventsQuery offset(@javax.annotation.Nullable Integer offset) {
    this.offset = offset;
    return this;
  }
  ...
  public EventsQuery orderings(@javax.annotation.Nullable List<String> orderings) {
  ...
  public EventsQuery searchString(@javax.annotation.Nullable String searchString) {
  ...
  public EventsQuery orderBy(@javax.annotation.Nullable String orderBy) {
