...
public class ValidationProblemDetails extends ProblemDetails {
  ...
  public ValidationProblemDetails errors(@javax.annotation.Nullable List<ValidationError> errors) {
    this.errors = errors;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ValidationProblemDetails.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ValidationProblemDetails` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  }
